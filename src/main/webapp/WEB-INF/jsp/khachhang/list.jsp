		...
		<section id="about" class="about">
			...
			<div class="row">
					...
					<tbody>
						<c:forEach var="c" items="${khachHangs}" varStatus="status">
							<tr>
								...
								<td>${c.diaChiEmail}</td>
								<td>
									<a href="delete?id=${c.maKH}" type="button" class="btn btn-danger">Delete</a>
									<a href="update/${c.maKH}" type="button" class="btn btn-success">Update</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
				...
				<div style="text-align: center;">
					<a class="btn btn-primary" style="float: left;" href="add">Add New Guest</a>
