	...
	<section id="about" class="about">
		<div class="container">
			...
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach var="c" items="${listDichVu}" varStatus="status">
						<tr>
							<th scope="row">${c.maDV}</th>
							<td>${c.tenDV}</td>
							<td>${c.donViTinh}</td>
							<td>${c.donGia}</td>
							<td><a href="delete?id=${c.maDV}" type="button"
								class="btn btn-danger">Delete</a> <a href="update/${c.maDV}"
