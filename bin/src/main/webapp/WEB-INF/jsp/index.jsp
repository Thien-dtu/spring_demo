...
<body>
	...
	<footer id="footer">
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>Serenity</span></strong>. All Rights
				Reserved
			</div>
			<div class="credits">
	...
	<!-- Vendor JS Files -->
	<script
		src="<c:url value="/resources/bootstrap/vendor/purecounter/purecounter_vanilla.js" /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/aos/aos.js " /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/bootstrap/js/bootstrap.bundle.min.js " /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/glightbox/js/glightbox.min.js " /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/isotope-layout/isotope.pkgd.min.js " /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/swiper/swiper-bundle.min.js " /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/waypoints/noframework.waypoints.js " /> "></script>
	<script
		src="<c:url value="/resources/bootstrap/vendor/php-email-form/validate.js " /> "></script>
